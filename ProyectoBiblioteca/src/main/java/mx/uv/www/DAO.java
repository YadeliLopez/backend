...
public class DAO {
    ...
    public static List<Usuario> dameUsuarios() {
        ...
        try {
            ...
            while (rs.next()) {
                Usuario u = new Usuario(rs.getString("id"), rs.getString("nombre"), rs.getString("password"),rs.getBoolean("tipo"));
                resultado.add(u);
            }
        } catch (Exception e) {
    ...
    public static String registrarUsuario(Usuario u) {
        ...
        try {
            ...
            stm.setBoolean(0, false); //HAY QUE PONER LA CONDICION PARA QUE CUANDO SEA 0=ESTUDIANTE, 1=ADMINISTRADOR
